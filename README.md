...
**Latest release:** [v1.2.1](https://github.com/YashvantHange/AgentArmor/releases/tag/v1.2.1) · [Changelog](CHANGELOG.md)
...
1. Download **`AgentArmor_1.2.1_x64-setup.exe`** or **`.msi`** from [Releases](https://github.com/YashvantHange/AgentArmor/releases/latest)
2. Run the installer
